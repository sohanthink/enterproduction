    ...
    <section className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-black via-[#0a0a0a] to-black">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(255,107,53,0.1) 0%, transparent 25%, transparent 75%, rgba(255,107,53,0.1) 100%)",
          }}
        />
      </div>
      ...
      {/* Content */}
      <div className="relative z-10 w-[85%] mx-auto px-4 md:px-6 text-center">
